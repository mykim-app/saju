...
/* ── 합·충·형·파·해 ─────────────────────────────────── */
export const STEM_HAP = { "0-5": "토", "1-6": "금", "2-7": "수", "3-8": "목", "4-9": "화" };
export const STEM_CHUNG = ["0-6", "1-7", "2-8", "3-9"];
export const YUKHAP = { "0-1": "토", "2-11": "목", "3-10": "화", "4-9": "금", "5-8": "수", "6-7": "화" };
export const CHUNG = ["0-6", "1-7", "2-8", "3-9", "4-10", "5-11"];
export const PA = ["0-9", "1-4", "2-11", "3-6", "5-8", "7-10"];
export const HAE = ["0-7", "1-6", "2-5", "3-4", "8-11", "9-10"];
export const WONJIN = ["0-7", "1-6", "2-9", "3-8", "4-11", "5-10"];
export const GWIMUN = ["0-9", "1-6", "2-7", "3-8", "4-11", "5-10"];
export const SAMHAP = [{ set: [8, 0, 4], el: "수", king: 0 }, { set: [11, 3, 7], el: "목", king: 3 }, { set: [2, 6, 10], el: "화", king: 6 }, { set: [5, 9, 1], el: "금", king: 9 }];
export const BANGHAP = [{ set: [2, 3, 4], el: "목" }, { set: [5, 6, 7], el: "화" }, { set: [8, 9, 10], el: "금" }, { set: [11, 0, 1], el: "수" }];
